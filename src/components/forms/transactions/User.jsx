...
export const User = () => {
  const { selectedTransaction, receiverReceived } = useTransfer();
  ...
  const itemStatusComponent = {
    delivered: (
      <div className="col-span-2 w-full">
        <ButtonActions
          name={"Received Item"}
          action={() => {
            receiverReceived(transactionId, itemId, "received");
            navigate(-1);
          }}
        />
      </div>
    ...
    pending: (
      <div className="col-span-2 w-full mt-6">
        <h3>You're item is waiting for admin approval</h3>
      </div>
    ),
    approval: (
      <div className="col-span-2 w-full mt-6">
    ...
    <>
      <section className="container mx-auto w-full">
        <div className="grid grid-cols-2 gap-4 px-4">
          ...
          {itemStatus === "approval" && (
            <div className="col-span-2 w-full mt-6">
              <h3>You're item is waiting for delivery</h3>
            </div>
          )}
          {itemStatus === "reject" && (
            <div className="col-span-2 w-full mt-6">
              <h3>You're item is rejected by your admin</h3>
            </div>
          )}
        </div>
      </section>
